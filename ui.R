...
shinyUI(navbarPage(
  ...
  tabPanel("Scenario Planning",
     ...
     numericInput("Growth", "Expected Monthly Growth/Decline of number of accounts (Enter Negative value for reduction in accounts)",
                  ...
                  width = NULL),
     numericInput("ResidentialSingle", "Residential Single accounts growth/decline", 
                  5, min = -1, max = 1000, step = 1,
                  width = NULL),
     numericInput("ResidentialMulti", "Residential Multi accounts growth/decline", 
                  1, min = -1, max = 1000, step = 1,
                  width = NULL),
     numericInput("Irrigation", "Irrigation accounts growth/decline", 
                  1, min = -1, max = 1000, step = 1,
                  width = NULL),
     numericInput("Commercial", "Commercial accounts growth/decline", 
                  1, min = -1, max = 1000, step = 1,
                  width = NULL),
     numericInput("Other", "Other accounts growth/decline", 
                  1, min = -1, max = 1000, step = 1,
                  width = NULL),
     numericInput("Institutional", "Institutional accounts growth/decline", 
                  1, min = -1, max = 1000, step = 1,
                  width = NULL),
