...
shinyUI(navbarPage(
  ...
  tabPanel("Scenario Planning",
     ...
     numericInput("Growth", "Expected Monthly Growth/Decline of number of accounts (Enter Negative value for reduction in accounts)",
                  ...
                  width = NULL),
     numericInput("ResidentialSingle", "Residential Single accounts proportion", 
                  0.5, min = -1, max = 1, step = 0.1,
                  width = NULL),
     numericInput("ResidentialMulti", "Residential Multi accounts proportion", 
                  0.1, min = -1, max = 1, step = 0.1,
                  width = NULL),
     numericInput("Irrigation", "Irrigation accounts proportion", 
                  0.1, min = -1, max = 1, step = 0.1,
                  width = NULL),
     numericInput("Commercial", "Commercial accounts proportion", 
                  0.1, min = -1, max = 1, step = 0.1,
                  width = NULL),
     numericInput("Other", "Other accounts proportion", 
                  0.1, min = -1, max = 1, step = 0.1,
                  width = NULL),
     numericInput("Institutional", "Institutional accounts proportion", 
                  0.1, min = -1, max = 1, step = 0.1,
                  width = NULL),
